      ...
      {socialLinks.map((item) => {
        return (
          <div key={item.code}>
            ...
            <div className={`tooltip-${item.code}`} data-pr-tooltip={item.code} data-pr-position="top">
              <a href={item.link} className="flex justify-content-center" alt={`Gokul's ${item.code}`} target="_blank" rel="noreferrer">
